...
void
getCache(benchmark::State& state)
{
  BFieldData data{};
...
BENCHMARK(getCache)->RangeMultiplier(2)->Range(1024, 8192);

void
getCacheVec(benchmark::State& state)
{
  BFieldData data{};
  double z{ 0 }, r{ 1250 }, phi{ 1.6 };
  // fill the cache, pass in current scale factor
...
BENCHMARK(getCacheVec)->RangeMultiplier(2)->Range(1024, 8192);
